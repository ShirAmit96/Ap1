...
vector<string> InputCheck::seperateString(string input)
{
...
vector<string> InputCheck::stringsValidation( vector<string> inputVec){
...
vector<double> InputCheck::vectorValidation( vector<string> inputVec){
...
vector<double> InputCheck::createNumbersVec(string input){
